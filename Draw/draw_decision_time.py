...
plt.plot(nodes[:idx],  bra[:idx], marker='.', ms=marker_size, label='BRA' , c=util.BASELINE_COLORS[0], linewidth=lw)
plt.plot(nodes[:idx],  lrp[:idx], marker='v', ms=marker_size, label='LRP' , c=util.BASELINE_COLORS[1], linewidth=lw)
plt.plot(nodes[:idx], dics[:idx], marker='^', ms=marker_size, label='DICS', c=util.BASELINE_COLORS[2], linewidth=lw)
plt.plot(nodes[:idx], kcss[:idx], marker='h', ms=marker_size, label='KCSS', c=util.BASELINE_COLORS[3], linewidth=lw)
plt.plot(nodes[:idx], odcs[:idx], marker='*', ms=marker_size, label='ODCS', c=util.BASELINE_COLORS[4], linewidth=lw)
plt.plot(nodes[:idx], rccs[:idx], marker='d', ms=marker_size, label='RCCS', c=util.BASELINE_COLORS[5], linewidth=lw)
